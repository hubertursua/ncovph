export default function confirmed(original: string | null, PH_masterl: string) {
  const caseNumber = parseInt(PH_masterl.substring(2));
  ...
  if (caseNumber > 2084) return "3/31/2020";
